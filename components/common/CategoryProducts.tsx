      ...
      <div className="flex flex-col md:min-w-40 border">
        {categories?.map((item) => (
          <Button
            ...
            className={`bg-transparent border-0 p-0 rounded-none text-zamzam-text-dark shadow-none hover:bg-dark-red hover:text-white font-semibold hoverEffect border-b last:border-b-0 capitalize ${item?.slug?.current === currentSlug && "bg-dark-red text-white border-dark-red"}`}
          >
